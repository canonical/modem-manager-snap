...
This repository builds and publishes a snap that repackages the `modem-manager`
...
- The upstream `modem-manager` package and other archive-sourced components.
...
- https://github.com/canonical/modem-manager-snap/security/advisories/new
...
`modem-manager` code), follow Ubuntu's security reporting process:
